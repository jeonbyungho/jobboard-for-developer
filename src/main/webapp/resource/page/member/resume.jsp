...
<body>
    ...
    <div class="top">
        ...
        <div class="career">
            <fieldset>
                <label for="careerCd" class="blind">경력구분</label>
                <select name="career_cd" id="careerCd">
            ...
            <div class="resume_snb">
                <div class="snb_container">
                    <div class="snb_box">
                        ...
                        <p class="txt"><em>기본정보</em>만 입력하면<br>이력서가 완성돼요!</p>
                        <ul class="item_list">
                            <li class="item active">
                                <a href="#mycareer" class="BtnType con_link">내 경력</a>
                            </li>
                            <li class="item essential">
                                <a href="#school_end" class="BtnType con_link">학력</a>
                            </li>
                            <li class="item">
                                <a href="#career_now" class="BtnType con_link">경력</a>
                            </li>
                            <li class="item add">
                                <a href="#skill" class="BtnType con_link">기술</a>
                            </li>
                        </ul>
                    </div>
                </div>
    ...
    <fieldset>
        <div class="box">
            <div id="school_end" class="content-section">
                <h2 class="school">학력<span class="must"></span></h2>
                <input type="checkbox" id="schoolRoot">
                <label for="schoolRoot">정보열기</label>
              <ul class="list">
                    <li class="list">
                        <div class="contents">   
                </ul>
